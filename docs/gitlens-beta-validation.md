...
1. Open Commit Graph in the editor. Modify a tracked file and right-click a commit in the current HEAD history. Confirm **Git Fixup: Create Fixup Commit (Beta)** is present.
